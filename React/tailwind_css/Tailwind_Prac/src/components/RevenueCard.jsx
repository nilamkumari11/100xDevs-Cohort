export const RevenueCard = ({
    ...
    return <div className="bg-white rounded shadow-lg p-4 hover:bg-red-100">
        <div className="text-gray-700 flex items-center">
            {title} 
            <div className="ml-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4.5">
